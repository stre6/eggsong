...
public class MusicActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = getIntent();
                    ...
                    banbor=(Button)findViewById(R.id.banbor);
                    gae=(Button)findViewById(R.id.gae);
                    ...
                    banbor.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            banbor.setSelected(true);
                            banbor.setVisibility(View.GONE);
                    ...
                    gae.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            banbor.setSelected(false);
                            banbor.setVisibility(View.VISIBLE);
                            gae.setVisibility(View.GONE);
                            mp.setLooping(false);
                        }
                    });
                    position++;
   ...
   public void NotificationSomethings(String title,String artist,Bitmap album){
        Intent notificationIntent= new Intent(this.getApplicationContext(),NotificationSomethings.class);
        notificationIntent.putExtra("notificationId",9999);
        PendingIntent contentIntent=PendingIntent.getActivity(this,0,notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Builder builder=new NotificationCompat.Builder(this);
        builder.setContentTitle(title)
                .setContentText(artist)
                .setTicker(MediaStore.Audio.Media.TITLE)
                .setSmallIcon(R.drawable.alsong)
                .setLargeIcon(album)
   ...
   public void playMusic(MusicDto musicDto) {
        ...
        try {
            ...
            NotificationSomethings(title.getText().toString(),artist.getText().toString(),bitmap);
